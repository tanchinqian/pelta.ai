        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-screen w-[420px] bg-surface border-l border-border z-40 p-6 shadow-2xl flex flex-col space-y-6 animate-slide-in">
            <div className="flex items-center justify-between pb-3 border-b border-border">
              ...
              <button 
                onClick={() => setSelectedTool(null)}
                className="text-text-secondary hover:text-text-primary text-sm font-mono px-2 py-1 rounded hover:bg-surface-hover cursor-pointer"
              >
                CLOSE
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-5 pr-1">
              <div>
                <h4 className="text-sm font-mono uppercase tracking-widest text-text-tertiary">Tool Name</h4>
                <p className="text-lg font-serif font-semibold text-text-primary mt-1">{selectedTool.name}</p>
                <p className="text-sm font-mono text-text-muted mt-0.5">ID: {selectedTool.id}</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {selectedTool.status !== 'pending' && (
                  <button
                    ...
                    className="flex items-center gap-1.5 text-base font-semibold text-text-secondary bg-surface-hover hover:bg-border border border-border rounded px-3 py-1.5 transition-colors cursor-pointer"
                  >
